...
- [x] 01-03-PLAN.md — Make the CLI-to-contained-state walking skeleton green

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-04-PLAN.md — Harden dependency, process, zero-network, and UTF-8 contracts
- [x] 01-05-PLAN.md — Prove path containment, native locking, atomicity, and recovery

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 01-06-PLAN.md — Complete schema-backed init, repair, and invalid-state preservation
- [x] 01-07-PLAN.md — Install exact-version local generations through PowerShell 5.1 and POSIX launchers

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 01-08-PLAN.md — Report complete ordered pre/post-init doctor diagnostics

**Wave 7** *(blocked on Wave 6 completion)*

- [x] 01-09-PLAN.md — Build offline smoke and least-privilege ordinary CI workflow
